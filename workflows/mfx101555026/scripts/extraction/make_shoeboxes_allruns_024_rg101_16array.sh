...
#SBATCH --mem=256G
#SBATCH --time=0-8:00
#SBATCH --job-name=mfx_all_box
#SBATCH --array=0-15
#SBATCH --output=/sdf/scratch/lcls/ds/prj/prjlumine22/scratch/thaoh/mfx101555026_cctbx/logs/mfx_all_box_%A_%a.out
#SBATCH --error=/sdf/scratch/lcls/ds/prj/prjlumine22/scratch/thaoh/mfx101555026_cctbx/logs/mfx_all_box_%A_%a.err
...
OUT_BASE=$BASE/mfx_shoebox_allruns_269_289_no275_024_rg101_chunks
...
# Ceiling division: files per task.
