...
class Loss(torch.nn.Module):
    ...
    def get_prior(self, name, params_prefix, device, default_return=None):
        ...
        if name == "gamma":
            ...
            # For Dirichlet, use the special dirichlet_concentration buffer
...
# %%
class tempppLoss(torch.nn.Module):
    def __init__(
        self,
        beta=1.0,
        eps=1e-5,
    ...
    def _move_distribution_to_device(self, dist, device):
        ...
        if isinstance(dist, torch.distributions.dirichlet.Dirichlet):
