...
# q_bg, q_I, profile, L, penalty, bg_profile = self.distribution_builder(
# representation, dxyz, dead_pixel_mask, is_flat.squeeze(-1)
# )

# rate = self.decoder(q_bg, q_I, profile, bg_profile)
...
# return nll, kl_term, rate, q_I, profile, q_bg, counts, L, penalty
...
# nll, kl_term, rate, q_I, profile, q_bg, counts, L, penalty = self(
# sbox, mask, is_flat
# )
