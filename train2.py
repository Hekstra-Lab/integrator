...
def main():
    ...
    data_module = ShoeboxDataModule(
        ...
        data_dir="/Users/luis/integratorv2/integrator/data/hewl_816",
    ...
    # checkpoint_path = "/n/holylabs/LABS/hekstra_lab/Users/laldama/integratorv2/integrator/lightning_logs/version_56735362/checkpoints/epoch=99-step=71300.ckpt"
    ...
    torch.save(
        final_outputs,
        "gamma_10_predictions_pI_scale_0001_gamma_03_1_no_recon_threshold_005.pt",
    )
    print("Done!")
