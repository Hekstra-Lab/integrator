...
PROJECT_DIR="/n/holylabs/LABS/hekstra_lab/Users/laldama/integratorv2"

# Set the path to your config file
CONFIG_FILE="$PROJECT_DIR/config/CNNResNet_MVNProfile_config.yaml"
...
python train.py --config $CONFIG_FILE --gpus 1 --log_dir $LOG_DIR
